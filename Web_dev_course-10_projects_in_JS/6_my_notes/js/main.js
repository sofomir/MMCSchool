...
const addNote = () => {
	if (textarea.value !== '' && category.options[category.selectedIndex].value !== 0 && selectedValue !== '' && selectedValue !== undefined) {
		createNote()
		error.style.visibility = 'hidden'
	} else {
...
const checkColor = (note) => {
	switch (selectedValue) {
		case 'Shopping':
			...
			break
		case 'Work':
			note.style.backgroundColor = '#ddd7f8ff'
			break
		case 'Others':
			note.style.backgroundColor = '#e5ffe6ff'
			break
	}
}
